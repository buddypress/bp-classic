<?php
/**
 * BP Classic Friends Widget Functions.
 *
 * @package bp-classic\inc\friends
 * @since 1.0.0
 */
 ...
 * @since 1.0.0
 */
function bp_classic_friends_register_friends_widget() {
	register_widget( 'BP_Classic_Friends_Widget' );
}
 ...
 * @since 1.0.0
 */
function bp_classic_friends_register_widgets() {
	...
	add_action( 'widgets_init', 'bp_classic_friends_register_friends_widget' );
}
add_action( 'bp_register_widgets', 'bp_classic_friends_register_widgets' );
